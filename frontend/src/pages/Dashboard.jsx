...
const getStatusClass = (status) => {
  ...
  if (["in_review", "under_review"].includes(value)) return "status-review";
  ...
  const statistics = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        value: money(metrics.totalCommissions),
        ...
        <section className="sales-dashboard-frame">
          ...
          <div className="sales-dashboard-content">
            <section className="sales-dashboard-hero">
              ...
              <p>Track vendor onboarding, commissions and recent registrations from one place.</p>
...
@media(max-width:350px){.sales-dashboard-content{padding-left:12px;padding-right:12px}.stats-grid{grid-template-columns:1fr}.stat-card.withdrawals{grid-column:auto;grid-template-columns:auto minmax(0,1fr)}.stat-card.withdrawals .stat-action{grid-column:1/-1;justify-content:center}}
